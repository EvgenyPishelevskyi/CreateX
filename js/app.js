(() => {
    ...
    (() => {
        ...
        function app() {
            ...
            const cards = document.querySelectorAll(".itemCoursec");
            function filter(category, items) {
                items.forEach((item => {
                    const isItemFiltered = !item.classList.contains(category);
                    const isShowAll = "all" === category.toLowerCase();
                    if (isItemFiltered && !isShowAll) item.classList.add("anime"); else {
            ...
            cards.forEach((itemCoursec => {
                itemCoursec.ontransitionend = function() {
                    if (itemCoursec.classList.contains("anime")) itemCoursec.classList.add("hide");
                };
            }));
        }
        app();
        document.addEventListener("DOMContentLoaded", (() => {
            const newYear = new Date("Jun 28 2022 00:00:00");
        ...
        function initSliders() {
            if (document.querySelector(".bestTutors__slider")) new core(".bestTutors__slider", {
            ...
            if (document.querySelector(".checkCourse__slider")) new core(".checkCourse__slider", {
                modules: [ Navigation, Pagination, EffectFade, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".checkOverEvents__slider")) new core(".checkOverEvents__slider", {
            ...
            if (document.querySelector(".alsoLike__slider")) new core(".alsoLike__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 0,
        ...
        tabs();
        showMore();
        const elem = document.querySelector(".ourOnlineCourses__catalog");
        const iso = new Isotope(elem, {
            itemSelector: ".catalogCourses__item",
            layoutMode: "masonry",
            persentPosition: true,
            masonry: {
                columnWidth: ".catalogCourses__item",
